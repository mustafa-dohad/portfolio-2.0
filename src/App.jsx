  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-gray-900 transition-colors duration-300">
      ...
      <div className="md:hidden">
        <DarkModeToggle isDark={theme === "dark"} onClick={handleThemeChange} />
      </div>
      {/* Main Content */}
      {/* Mobile Header */}
      <header className="md:hidden w-full flex items-center justify-start py-4 pl-5 font-baloo text-xl font-bold tracking-wide text-gray-900 dark:text-white select-none border-b border-neutral-200 dark:border-neutral-700">
        {'< mustafa />'}
      </header>
      <PersonalInfo />
